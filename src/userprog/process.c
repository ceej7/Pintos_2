...
process_execute (const char *file_name) 
{
  ...
  //My implement
  //file_name is changeable
  //so using strtok to extract the first arg
  char *save_ptr;
...
start_process (void *file_name_)
{
  ...
  //My implement
  // Get actual file name ,the same to that in process_execute
  char *save_ptr;
  ...
  if (!success) 
  {
  	//printf("user program did not run successfully!!!!!\n");
  	thread_exit ();
  }
